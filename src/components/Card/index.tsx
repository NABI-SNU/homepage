...
export const Card: React.FC<{
  ...
  return (
    <article
      className={cn(
        'group relative overflow-hidden rounded-2xl border border-border/80 bg-card/70 shadow-sm transition-all duration-300 ease-out hover:cursor-pointer hover:-translate-y-1 hover:scale-[1.01] hover:border-primary/30 hover:shadow-xl',
        className,
      )}
      ref={card.ref}
    >
